...
class _GroupScreenState extends State<GroupScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final availableMembers =
        Provider.of<MembersGroupsModel>(context).thisGroupAvailableMembers(id);
        ...
        children: <Widget>[
          Container(
            ...
            child: Column(children: [
              Card(
                child: ListTile(
                  title: Row(
                    ...
                    children: [
                      Text(
                          '${availableMembers.length} / ${thisGroupMembers.length} ${getTranslation(context, 'members_present')}'),
                    ],
                  ),
                ),
              ),
              ...
              Row(
                children: [
                  Text(getTranslation(context, 'absent')),
                ],
              )
            ]),
          ),
                        ...
                        onChanged: (bool checked) {
                          ...
                          if (member.isAbsent) {
                            ...
                            Scaffold.of(context).showSnackBar(SnackBar(
                              content: Text(
                                '${member.memberName} ${getTranslation(context, 'marked_absent')}',
